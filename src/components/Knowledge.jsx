...
function Knowledge() {
  return (
    <main className="container mt-5">
      ...
      <hr />
      <p className="lead">
        Jag har bekantat mig med ett antal olika teknologier och jag gillar att
        lära mig nya och att födjupa mig för att ständigt utvecklas. Nedan
        redovisar jag några av de teknologier jag är mest bekväm med.
      </p>
